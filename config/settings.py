...
TREEMAP_EXECUTION_COLORS = ['#fff2aa', '#fcddd2', '#e8d0d0', '#e0d4e8', '#cfe1ed']
TREEMAP_EXECUTION_COLORS_HOVER = {
    TREEMAP_EXECUTION_COLORS[0]: '#f2cc05',
    TREEMAP_EXECUTION_COLORS[1]: '#f2571c',
    TREEMAP_EXECUTION_COLORS[2]: '#8c1717',
