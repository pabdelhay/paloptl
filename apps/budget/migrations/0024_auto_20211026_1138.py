    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='budget.Category', verbose_name='category')),
            ...
            options={
                ...
                'ordering': ['code', 'country', 'category'],
