...
from api.students.mocambique_momade import MocambiqueMomadeViewset
...
router.register(r'mocambique-momade', MocambiqueMomadeViewset, basename='mocambique_momade_api')
