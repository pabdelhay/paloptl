...
from frontend.student_views.mozambique_custodio import MozambiqueCustodio
...
urlpatterns = [
    ...
    path('students/mozambique/mozambique_custodio/', MozambiqueCustodio.as_view(), name='mozambique_custodio'),
